...
from bsgnn.features import get_available_features_generators
...
def add_predict_args(parser: ArgumentParser):
    ...
    parser.add_argument('--preds_path', type=str,
                        ...
                        default='./result/predict_result.csv',)
...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--dataset_name', type=str,
                        help='the dataset name')
    parser.add_argument('--result_path', type=str, default='./result/df_test_result_regression',
